        ...
        <DialogHeader>
          <ScrollArea className="h-[95vh] w-full py-5">
            ...
            <form
              ...
              className="flex flex-col gap-6 py-4 md:p-4"
            >
              {/* issue type */}
              <div>
                <p className="text-left text-sm font-medium text-gray-700 dark:text-gray-300">
                  Issue Type
                </p>
                <Select
              ...
              <div>
                ...
                <p className="mt-1 text-left text-xs font-medium text-gray-500 dark:text-gray-400">
